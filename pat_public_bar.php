	...
	function pat_public_bar($atts) {
		...
		if ( cs('txp_login_public') && true != $prefs['pat_public_bar_disable'] ) {
			...
			*/
			...
			$category = ( ($thisarticle['category1'] || $thisarticle['category2']) ? '<li><a href="'.ahu.'index.php?event=category"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" x="0" y="0" viewBox="0 0 28 28" xml:space="preserve"><path d="M15 18v-4h-4v8l4 0V20h8v8h-8v-4H9V8H5V0h8v8h-2v4h4v-2h8v8H15z"/></svg>&nbsp;&bull;&nbsp;'.ucfirst(gTxt('categories')).'&nbsp;:&nbsp;'.gtxt('edit').'</a></li>' : '');
