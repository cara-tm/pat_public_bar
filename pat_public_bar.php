	...
	function pat_public_bar($atts) {
		...
		if ( cs('txp_login_public') && true != $prefs['pat_public_bar_disable'] ) {
			...
			*/
			...
			$article = '<li>'.(
			$thisarticle['thisid'] ? 
				'<strong>'.$add.'</strong> / <strong><a href="'.$interface.'/index.php?event=article&amp;step=edit&amp;ID='.$thisarticle['thisid'].'&amp;_txp_token='.form_token().'">'.gTxt('edit').'  (<strong>'.$pretext['s'].'</strong>)</a></strong>' : 
				$add 
			).'</li>';
			...
			$disconnect = '<li><hr>&nbsp;</li><li><a href="'.$interface.'/index.php?logout=1"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="22" height="22" viewBox="0 0 32 32" xml:space="preserve"><polygon points="8 0 8 8 12 8 12 4 28 4 28 28 12 28 12 24 8 24 8 32 32 32 32 0 " fill="'.$icon.'"/><polygon points="14 22 20 16 14 10 14 14 0 14 0 18 14 18"/></svg>&nbsp;&bull;&nbsp;'.gTxt('logout').'&nbsp;</a></li>';
	
			return <<<EOT
	
<<<<<<< HEAD
<div id="pat-previewer-plugin"><span><img width="22" height="22" src="data:image/png;base64," aria-hidden="true" alt="pat-public-admin-bar for TXP CMS" />&nbsp;&nbsp; {$prefs['sitename']}</span><ul>{$logged}<li><a href="{$interface}" style="color:#ffda44">Textpattern CMS {$prefs['version']}</a></li><li><a href="https://forum.textpattern.io/" target=_blank"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 45.6 45.6"><path d="M43.2 37.6L31.2 15.4V2.2C31.2 1 30.2 0 28.9 0H16.7c-1.2 0-2.3 1-2.3 2.2v13.2L2.5 37.6c-0.9 1.7-0.9 3.7 0.1 5.4 1 1.6 2.8 2.7 4.7 2.7h31.1c1.9 0 3.7-1 4.7-2.7C44 41.3 44.1 39.3 43.2 37.6zM24.8 28.3c1.1 0 1.9 0.9 1.9 1.9 0 1.1-0.9 1.9-1.9 1.9 -1.1 0-1.9-0.9-1.9-1.9C22.9 29.2 23.7 28.3 24.8 28.3zM19.3 16.6c1.1 0 1.9 0.9 1.9 1.9 0 1.1-0.9 1.9-1.9 1.9 -1.1 0-1.9-0.9-1.9-1.9C17.4 17.5 18.3 16.6 19.3 16.6zM19.3 23.4c1.7 0 3.1 1.4 3.1 3.1 0 1.7-1.4 3.1-3.1 3.1 -1.7 0-3.1-1.4-3.1-3.1S17.6 23.4 19.3 23.4zM37.4 39.6c-0.4 0.7-1.1 1.1-1.9 1.1H10.2c-0.8 0-1.5-0.4-1.9-1.1 -0.4-0.7-0.4-1.5 0-2.2l3-5.5c0.4-0.8 1.3-1.2 2.2-1.1 4 0.4 8.6 3.8 12.6 3.7 2.2-0.1 4.2-0.9 6.1-1.9 1.1-0.6 2.5-0.2 3.1 0.9l2.2 4C37.8 38 37.8 38.9 37.4 39.6z"/></svg>&nbsp;&bull;&nbsp;TXP Forum</a></li> {$section} {$page} {$form} {$style} {$file} {$link} {$category} {$article} {$image} {$comment} {$pref} {$log} {$disconnect} </ul></div><style scoped>body{padding-top:35px!important}#pat-previewer-plugin{position:{$position};z-index:9999;top:{$js_top_adjust}px;left:0;min-width:350px;width:100%;height:35px;background:{$bgcolor};box-sizing:content-box;border-top:10px solid rgba(0,0,0,.8);color:{$color};font-size:14px;line-height:25px;font-family:"HelveticaNeue-Light","Helvetica Neue Light","Helvetica Neue",Helvetica,Arial,"Lucida Grande",sans-serif;font-weight:300;cursor:default;box-shadow:0 3px 5px rgba(0,0,0,0.3);backface-visibility:hidden}#pat-previewer-plugin::before{content:" ";display:block;position:absolute;z-index:9999;top:0;left:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-top:10px solid {$color}}#pat-previewer-plugin:hover::before{border:0}#pat-previewer-plugin span{position:absolute;z-index:9998;top:-5px;left:0;float:left;min-width:320px;margin:0 auto 0;padding:9px 2.5% 0px 2%;background:{$bgcolor}}#pat-previewer-plugin:hover span{display:block;color:#2ea2cc;background:{$bgcolor}}#pat-previewer-plugin span b{float:right;font-weight:normal}#pat-previewer-plugin img{display:inline;width:22px;margin:0;vertical-align:middle}#pat-previewer-plugin ul{position:absolute;top:-800px;width:320px;margin:35px 0 0 0;padding:0 0 30px 30px;background:{$bgcolor};box-shadow:0 3px 5px rgba(0,0,0,.3);transition:top 800ms ease 0s}#pat-previewer-plugin:hover ul{display:block;top:0}#pat-previewer-plugin ul li{max-width:90%;margin-left:0;list-style:none;color:#84878b;line-height:30px}#pat-previewer-plugin a{overflow:hidden;display:block;border:none;white-space:nowrap;outline:none;text-overflow:ellipsis;text-decoration:none;color:{$color}}#pat-previewer-plugin a:hover{color:{$hover}}#pat-previewer-plugin strong{text-overflow:ellipsis;font-weight:normal}#pat-previewer-plugin strong a{display:inline;text-overflow:ellipsis}#pat-previewer-plugin svg{vertical-align:middle}#pat-previewer-plugin svg *{fill:{$icon}}#pat-previewer-plugin a:hover svg path,#pat-previewer-plugin a:hover svg *{fill:{$hover}!important}#pat-previewer-plugin hr{position:relative;z-index:0;top:25px;left:185px;width:100px;height:1px;margin:5px 0;background:{$title};border:medium none}</style><script>(function(){'use strict';var _el=document.getElementById('pat-previewer-plugin');if(window.innerHeight<660){_el.style.position='absolute';_el.style.top='{$js_top_adjust}';}})();</script>
=======
<div id="pat-previewer-plugin"><span><img width="22" height="22" src="data:image/png;base64," aria-hidden="true" alt="pat-public-admin-bar for TXP CMS" />&nbsp;&nbsp; {$prefs['sitename']}</span><ul>{$logged}<li><a href="{$interface}" style="color:#ffda44">Textpattern CMS {$prefs['version']}</a></li><li><a href="https://forum.textpattern.io/" target=_blank"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 45.6 45.6"><path d="M43.2 37.6L31.2 15.4V2.2C31.2 1 30.2 0 28.9 0H16.7c-1.2 0-2.3 1-2.3 2.2v13.2L2.5 37.6c-0.9 1.7-0.9 3.7 0.1 5.4 1 1.6 2.8 2.7 4.7 2.7h31.1c1.9 0 3.7-1 4.7-2.7C44 41.3 44.1 39.3 43.2 37.6zM24.8 28.3c1.1 0 1.9 0.9 1.9 1.9 0 1.1-0.9 1.9-1.9 1.9 -1.1 0-1.9-0.9-1.9-1.9C22.9 29.2 23.7 28.3 24.8 28.3zM19.3 16.6c1.1 0 1.9 0.9 1.9 1.9 0 1.1-0.9 1.9-1.9 1.9 -1.1 0-1.9-0.9-1.9-1.9C17.4 17.5 18.3 16.6 19.3 16.6zM19.3 23.4c1.7 0 3.1 1.4 3.1 3.1 0 1.7-1.4 3.1-3.1 3.1 -1.7 0-3.1-1.4-3.1-3.1S17.6 23.4 19.3 23.4zM37.4 39.6c-0.4 0.7-1.1 1.1-1.9 1.1H10.2c-0.8 0-1.5-0.4-1.9-1.1 -0.4-0.7-0.4-1.5 0-2.2l3-5.5c0.4-0.8 1.3-1.2 2.2-1.1 4 0.4 8.6 3.8 12.6 3.7 2.2-0.1 4.2-0.9 6.1-1.9 1.1-0.6 2.5-0.2 3.1 0.9l2.2 4C37.8 38 37.8 38.9 37.4 39.6z"/></svg>&nbsp;&bull;&nbsp;TXP Forum</a></li> {$section} {$page} {$form} {$style} {$file} {$link} {$category} {$article} {$image} {$comment} {$pref} {$log} {$disconnect} </ul></div><style scoped>body{margin-top:35px!important}#pat-previewer-plugin{position:absolute;position:{$position};z-index:9999;top:-10px;left:0;min-width:350px;width:100%;height:35px;background:{$bgcolor};box-sizing:content-box;border-top:10px solid rgba(0,0,0,.8);color:{$color};font-size:14px;line-height:25px;font-family:"HelveticaNeue-Light","Helvetica Neue Light","Helvetica Neue",Helvetica,Arial,"Lucida Grande",sans-serif;font-weight:300;cursor:default;box-shadow:0 3px 5px rgba(0,0,0,0.3);backface-visibility:hidden}#pat-previewer-plugin::before{content:" ";display:block;position:absolute;z-index:9999;top:0;left:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-top:10px solid {$color}}#pat-previewer-plugin:hover::before{border:0}#pat-previewer-plugin span{position:absolute;z-index:9998;top:-5px;left:0;float:left;min-width:320px;margin:0 auto 0;padding:9px 2.5% 0px 2%;background:{$bgcolor}}#pat-previewer-plugin:hover span{display:block;color:#2ea2cc;background:{$bgcolor}}#pat-previewer-plugin span b{float:right;font-weight:normal}#pat-previewer-plugin img{display:inline;width:22px;margin:0;vertical-align:middle}#pat-previewer-plugin ul{position:absolute;top:-800px;width:320px;margin:35px 0 0 0;padding:0 0 30px 30px;background:{$bgcolor};box-shadow:0 3px 5px rgba(0,0,0,.3);transition:top 800ms ease 0s}#pat-previewer-plugin:hover ul{display:block;top:0}#pat-previewer-plugin ul li{max-width:90%;margin-left:0;list-style:none;color:#84878b;line-height:30px}#pat-previewer-plugin a{overflow:hidden;display:block;border:none;white-space:nowrap;outline:none;text-overflow:ellipsis;text-decoration:none;color:{$color}}#pat-previewer-plugin a:hover{color:{$hover}}#pat-previewer-plugin strong{font-weight:normal}#pat-previewer-plugin strong a{display:inline}#pat-previewer-plugin svg{vertical-align:middle}#pat-previewer-plugin svg *{fill:{$icon}}#pat-previewer-plugin a:hover svg path,#pat-previewer-plugin a:hover svg *{fill:{$hover}!important}#pat-previewer-plugin hr{position:relative;z-index:0;top:25px;left:185px;width:100px;height:1px;margin:5px 0;background:{$title};border:medium none}</style><script>(function(){'use strict';var _el=document.getElementById('pat-previewer-plugin');if(window.innerHeight<630){_el.style.position='absolute';_el.style.top='{$js_top_adjust}';}})();</script>
>>>>>>> 671946cd6e4f25c9025f12778e10dc1c1f978e5e
EOT;
